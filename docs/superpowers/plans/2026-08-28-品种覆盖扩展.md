...
- [ ] **Step 3: 实现 `providers/futures.py`**
...
- [ ] **Step 3: 实现 `providers/options.py`**
...
- [ ] **Step 1: 在 `tests/test_stock.py` 末尾追加失败测试**
...
- [ ] **Step 1: 更新 `tests/test_server.py`（先失败）**
...
- [ ] **Step 1: frontmatter description 补触发词**
